...
echo Start Raw Data File Copying-
     ...
     copy /-y /v c:\data\ctd\%2%3.XMLCON   c:\data_archives\current\*.*
     copy /-y /v c:\data\ctd\%2%3.XMLCON   c:\data\ctd\%2%3.xmlcon
     copy /-y /v c:\data\ctd\%2%3.bl    c:\data_archives\current\*.*
     copy /-y /v c:\data\ctd\%2%3.mrk   c:\data_archives\current\*.*
