...
rem Operation
rem   Only two command line entries needed: newgo and castname
rem   newgo at2630005
...
set batchtext=newbatch_sssg.txt
...
echo Start SbeBatch
call sbebatch c:\data\ctd\doc\processing_setup\%batchtext% %1 %contype% %indir% %outdir% %2
