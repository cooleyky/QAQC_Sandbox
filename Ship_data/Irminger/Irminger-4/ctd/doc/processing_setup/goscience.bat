...
rem goscience.bat, a windows batch file to backup 
...
rem like this: 
rem go at18-06 at18-06 003 process batch_science.txt
rem on Neil Armstrong it's goscience ar01-05 ar0105 001 process batch_science.txt
...
rem example:
rem go at18-06 at18-06 003 process batch_science.txt #w
...
echo Start Raw Data File Copying-
     ...
     copy /-y /v d:\data\%2%3.XMLCON   c:\ctd_backup\current\*.*
